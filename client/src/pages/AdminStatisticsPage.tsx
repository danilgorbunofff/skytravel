                ...
                >
                  <g className="text-muted-foreground text-[11px]">
                    ...
                    <line
                      ...
                      strokeOpacity="0.2"
                    />
                    <text x="8" y="18" fill="currentColor">
                      100
                    </text>
                    <text x="12" y="72" fill="currentColor">
                      50
                    </text>
                    <text x="16" y="122" fill="currentColor">
                      0
                    </text>
                    <text x="30" y="142" fill="currentColor">
                      Po
                    </text>
                    <text x="82" y="142" fill="currentColor">
                      Út
                    </text>
                    <text x="134" y="142" fill="currentColor">
                      St
                    </text>
                    <text x="186" y="142" fill="currentColor">
                      Čt
                    </text>
                    <text x="238" y="142" fill="currentColor">
                      Pá
                    </text>
                    <text x="290" y="142" fill="currentColor">
                      So
                    </text>
                    <text x="332" y="142" fill="currentColor">
                      Ne
                    </text>
                  </g>
                  <polyline
              ...
              {ordered.map((tour) => (
                <TableRow key={`stats-${tour.id}`}>
                  ...
                  <TableCell className="text-right font-medium">
                    {Math.floor(1200 + (tour.id ?? 1) * 83)}
                  </TableCell>
                  <TableCell className="text-right font-medium">
                    {Math.floor(60 + (tour.id ?? 1) * 6)}
                  </TableCell>
                  <TableCell className="text-right font-medium">
                    {Math.floor(30 + (tour.id ?? 1) * 4)}
                  </TableCell>
                </TableRow>
              ))}
            </TableBody>
